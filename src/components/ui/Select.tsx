    ...
    return (
      <div className="space-y-1.5">
        ...
        <select
          ...
          className={cn(
            'w-full px-4 py-2.5 rounded-xl bg-white/5 border border-white/10 text-text-primary outline-none transition-colors duration-300 focus:bg-white/10 focus:ring-2 focus:ring-brand-primary/50 focus:border-brand-primary/50 appearance-none cursor-pointer',
